...
def write_report(
    ...
    lines = [
        ...
        "## 2. 방법론 참고 문헌",
        "",
        "이 분석의 문제의식은 Oparina et al. (2025)의 *Machine learning in the prediction of human wellbeing*을 참고했다. 해당 연구는 독일, 영국, 미국의 대규모 대표 표본을 활용해 삶의 만족도와 주관적 웰빙을 예측하고, Random Forest, Gradient Boosting, LASSO 등 여러 방법을 통해 웰빙을 설명하는 주요 변수를 탐색했다.",
        "",
        "특히 이 논문에서 참고한 점은 머신러닝을 단순한 예측 도구로만 쓰지 않고, 삶의 만족도와 관련된 요인을 데이터 기반으로 탐색했다는 점이다. 본 보고서도 같은 문제의식을 한국의 지역 단위 KOSIS 자료에 적용해, 수도권/비수도권이라는 구분 자체보다 고용 안정성, 청년 정착 가능성, 여성 고용 참여, 근로시간, 지역 산업 기반 같은 생활 여건 지표가 어떤 구조적 차이를 만드는지 확인하고자 했다.",
        "",
        "다만 본 보고서는 아직 삶의 만족도 원자료와 여러 생활영역 전체를 결합한 ML 예측모형을 구축한 단계는 아니다. 따라서 Oparina et al. (2025)을 직접 재현한 분석이라기보다, `삶의 만족도를 다양한 생활여건 지표로 설명하고 중요 요인을 탐색한다`는 접근 방식을 참고한 고용 영역 중심의 선행 분석으로 해석한다.",
        "",
        "- 참고 논문: Ekaterina Oparina et al., “Machine learning in the prediction of human wellbeing,” *Scientific Reports* 15, Article 1632 (2025), published 10 January 2025. https://www.nature.com/articles/s41598-024-84137-1",
        "",
        "## 3. 원본 데이터 EDA",
        "",
